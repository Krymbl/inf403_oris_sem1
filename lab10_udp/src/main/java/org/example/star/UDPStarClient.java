...
public class UDPStarClient {
    ...
    public static void main(String[] args) {
        ...
        try (DatagramSocket socket = new DatagramSocket()) {
            //socket.setSoTimeout(TIMEOUT); максимальное время ожидания ответа

            // Получаем IP-адрес сервера по доменному имени
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    int clientId = 0;
                    // Если тип = 2 (личное сообщение), читаем ID отправителя
                    if (typeMessage == 2) {
